    ...
    private void setupBackNavigation() {
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                // خطأ منطقي سابق: كان الزر لا يحاول webView.goBack() إطلاقاً
                // أثناء عرض شاشة "غير متصل"، فيعلق المستخدم عليها بلا مخرج.
                // الآن: نحاول دائماً الرجوع في تاريخ WebView أولاً، وإن تعذر
                // ذلك نعيد تحميل الصفحة الرئيسية مباشرة.
                if (isOfflinePageShown) {
                    showContent();
